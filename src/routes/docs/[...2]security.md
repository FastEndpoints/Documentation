...
- [ApiKey authentication with Swagger UI support](https://discord.com/channels/933662816458645504/1073811284258209812)
- [Session based auth with Swagger UI support](https://discord.com/channels/933662816458645504/1112275411762692196)

**Note:** You may need to join the discord server first using the invite link on the top menu in order to access the above code snippets.
