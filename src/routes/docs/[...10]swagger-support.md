...
Client generation is facilitated by the [Kiota](https://learn.microsoft.com/en-us/openapi/kiota/design) library by Microsoft. You can use our wrapper
...
If you're not doing client generation and would like to export swagger docs only, have a look at this [gist](https://gist.github.com/dj-nitehawk/dc0018ab4a446764ef3c87213bf96959).
