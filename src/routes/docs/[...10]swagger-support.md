...
To avoid this, add **_--urls http://127.0.0.1:0_** to the command or set **_EnvironmentVariables="ASPNETCORE_URLS=http://127.0.0.1:0"_** as part of the **_&lt;Exec&gt;_** element. Using port 0 automatically selects an inactive port for your app to start the client export.
:::
