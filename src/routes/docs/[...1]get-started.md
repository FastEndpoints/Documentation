...
Install the latest library version using one of the following commands:

```cs |copy|title=terminal
  dotnet add package FastEndpoints //dotnet cli
  Install-Package FastEndpoints //nuget package manager
```
