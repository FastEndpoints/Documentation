...
You can have a look at the [integration tests here](https://github.com/FastEndpoints/FastEndpoints/tree/main/Tests/IntegrationTests/FastEndpoints/WebTests) in the meantime to get a quick idea.
:::
