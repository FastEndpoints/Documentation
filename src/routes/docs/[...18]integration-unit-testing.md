...
guaranteed (unless we do explicit ordering). Inherit **TestBase&lt;TAppFixture&gt;** to create a test-class:
...
This approach allows your test suit to have just a couple of derived **AppFixtures**, each representing a uniquely configured SUT(live app/WAF instance), while each
...
- [FastEndpoints Test Suit](https://github.com/FastEndpoints/FastEndpoints/tree/main/Tests) - how we test the library.
