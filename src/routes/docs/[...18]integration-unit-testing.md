...
Starting with .NET 7.0, you have the ability to write unit tests [like this](https://github.com/FastEndpoints/FastEndpoints/blob/075a6bfa79f1a4ef45a19419f1a8eb912159e182/Tests/UnitTests/FastEndpoints.UnitTests/WebTests/UnitTests.cs#L139-L156) by implementing **ExecuteAsync()** and returning the built-in union type as mentioned [here](get-started#union-type-returning-handler).
:::
