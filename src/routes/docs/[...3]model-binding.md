...
Instead of implementing your own request binder from scratch as shown above, it is also possible to simply inherit from the built-in default binder like so:
```cs
