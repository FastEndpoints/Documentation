...
- Use multiple form fields with the same name for binding to primitive collection properties as well as **IFormFileCollection** properties as shown above with fields such as:
    - BarCodes / AlternateCovers / Editor.Agreements
- Use indexing for referring to properties of complex types of a collection, such as in the case of the **Authors** property. Indexing should not be used for any other purpose.
- Use 'dot notation' for referring to properties of a single complex type as with the **Editor.Name** field.
...
- Use multiple keys with the same name for binding to primitive collection properties such as the **BarCodes** property above.
- Use indexing for referring to properties of complex types of a collection, such as in the case of the **Authors** property. Indexing should not be used for any other purpose.
- Use 'dot notation' for referring to properties of a single complex type as with the **Editor.Name** field.
