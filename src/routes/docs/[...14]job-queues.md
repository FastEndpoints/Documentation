      ...
      IDistributedJobStorageProvider<JobRecord>
{
    ...
    public Task<ICollection<JobRecord>> GetNextBatchAsync(
        PendingJobSearchParams<JobRecord> p)
        => Task.FromResult<ICollection<JobRecord>>(Array.Empty<JobRecord>());

    public async Task<ICollection<JobRecord>> AtomicGetNextBatchAsync(
        PendingJobSearchParams<JobRecord> p)
    {
