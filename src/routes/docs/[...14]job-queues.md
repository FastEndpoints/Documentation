...
If using EF Core as the ORM, [see here](https://gist.github.com/dj-nitehawk/02420788fb0a72c4be4752be8bd4c40b) how to configure it to support storing job storage entities.