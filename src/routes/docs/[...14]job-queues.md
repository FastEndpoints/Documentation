...
The scheduler keeps each queue filled up to the configured concurrency limit. As soon as one command finishes, the next eligible command can start without waiting for the rest of an earlier fetch to complete.
