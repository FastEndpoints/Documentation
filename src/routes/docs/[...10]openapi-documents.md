...
| **DocumentSettings**          | Sets the document name, title, version, and auth schemes.                       |
...
| **FlattenSchema**             | Flattens inherited schemas.                                                     |
...
| **RemoveEmptyRequestSchema**  | Removes empty request body schemas.                                             |
