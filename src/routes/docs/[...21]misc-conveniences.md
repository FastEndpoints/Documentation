...
- <span id="scat"/>**.CreatedAtAsync()**
  Sends a **201 created** response with a **Location** header containing where the resource can be retrieved from. [See note](openapi-support#custom-endpoint-names) about using with custom endpoint names.

- <span id="saat"/>**.AcceptedAtAsync()**
  Sends a **202 accepted** response with a **Location** header containing where the resource can be retrieved from. [See note](openapi-support#custom-endpoint-names) about using with custom endpoint names.
