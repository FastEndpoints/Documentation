<script lang="ts">
	// local copy of the svelte-spotlight component which fixes the
	// overflow: auto styles being set on the body element
	// TODO: remove when this is fixed upstream and use the svelte-spotlight package
